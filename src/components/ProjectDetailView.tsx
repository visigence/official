...
const ProjectDetailView: React.FC<ProjectDetailViewProps> = ({ project, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="relative min-h-screen w-full glass-strong"
    >
      {/* Close Button */}
      <button
        onClick={onClose}
        className="fixed top-6 right-6 z-20 p-3 glass rounded-lg neon-glow hover:neon-glow-accent transition-all duration-300"
      ...
      <div className="relative h-full">
        ...
        {project.liveComponent && project.id === 'enterprise-3d-editor' ? (
          ...
          <div className="h-full overflow-y-auto custom-scrollbar min-h-screen">
            {/* Hero Image */}
